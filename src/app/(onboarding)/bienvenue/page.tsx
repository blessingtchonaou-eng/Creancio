...
export default async function BienvenuePage() {
  ...
  const initial = entreprise
    ? { raisonSociale: entreprise.raisonSociale, nif: entreprise.nif ?? "", telephone: entreprise.telephone ? nationalTogoPhone(entreprise.telephone) : "" }
    : undefined;
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card className="flex flex-col gap-5">
        ...
        <EntrepriseForm initial={initial} />
      </Card>
    </div>
  );
}
