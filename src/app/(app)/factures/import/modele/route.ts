...
export async function GET() {
  ...
  feuille.addRow({ numero: "FA-2026-0001", client: "Kofi Agbo", telephone: "90 12 34 56", montant: 150_000, echeance: new Date(Date.UTC(2026, 9, 25)) });
  feuille.addRow({ numero: "FA-2026-0002", client: "Ama Mensah", telephone: "+228 70 12 34 56", montant: 1_250_000, echeance: new Date(Date.UTC(2026, 10, 5)) });
